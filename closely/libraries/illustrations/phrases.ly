...
\score {
    \new Score <<
        ...
        \context Staff = "star_iii_aconstant_pitch_-2" \with {
            \consists Horizontal_bracket_engraver
        } {
            \set Staff.instrumentName = \markup { Star_iii_aconstant_pitch_-2 }
            \set Staff.shortInstrumentName = \markup { Star_iii_aconstant_pitch_-2 }
            {
                bf4.
                bf4
                bf4
